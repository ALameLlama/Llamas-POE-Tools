...
class AbberathTouched extends Component
{
    ...
    {
        $this->childRecipes = [
            'flame-strider' => Storage::disk('local')->get("{$this->parent}_{$this->name}_flame-strider") ?? false,
            'rejuvenating' => Storage::disk('local')->get("{$this->parent}_{$this->name}_rejuvenating") ?? false,
