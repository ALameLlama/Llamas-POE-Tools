...
class Rejuvenating extends Component
{
    ...
    private function setChildrenRecipes()
    {
        $this->childRecipes = [
            ...
            'vampiric' => Storage::disk('local')->get(Auth::id() . '/' . "{$this->parent}_{$this->name}_vampiric") ?? false,
        ];
    ...
    {
        return view('livewire.archnemesis.rejuvenating');
    }
}
