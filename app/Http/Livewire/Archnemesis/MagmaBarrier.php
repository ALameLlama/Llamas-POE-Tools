...
class MagmaBarrier extends Component
{
    public bool $owned = false;
    public bool $childOwned = false;

    public string $name = 'magma-barrier';
    ...
    {
        $this->childRecipes = [
            'incendiary' => Storage::disk('local')->get(Auth::id() . '/' . "{$this->parent}_{$this->name}_incendiary") ?? false,
    ...
    {
        return view('livewire.archnemesis.magma-barrier');
    }
}
