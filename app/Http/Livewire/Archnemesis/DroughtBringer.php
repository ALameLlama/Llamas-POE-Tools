...
class DroughtBringer extends Component
{    public bool $owned = false;
    public bool $childOwned = false;

    public string $name = 'drought-bringer';
    ...
    {
        $this->childRecipes = [
            'malediction' => Storage::disk('local')->get("{$this->parent}_malediction") ?? false,
            'deadeye' => Storage::disk('local')->get("{$this->parent}_deadeye") ?? false,
        ];
    ...
    {
        return view('livewire.archnemesis.drought-bringer');
    }
}
