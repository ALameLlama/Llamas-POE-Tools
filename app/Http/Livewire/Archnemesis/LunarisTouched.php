...
class LunarisTouched extends Component
{
    public bool $owned = false;
    public bool $childOwned = false;

    public string $name = 'lunaris-touched';
    ...
    private function setChildrenRecipes()
    {
        $this->childRecipes = [
            ...
            'frost-strider' => Storage::disk('local')->get(Auth::id() . '/' . "{$this->parent}_{$this->name}_frost-strider") ?? false,
        ];
    ...
    {
        return view('livewire.archnemesis.lunaris-touched');
    }
}
